...
- `sar:relative_burst` (was in the README before, but not part of the schema)
...
[v2.0.0]: <https://github.com/stac-extensions/sar/compare/v1.3.2...v2.0.0>
[v1.3.2]: <https://github.com/stac-extensions/sar/compare/v1.3.1...v1.3.2>
